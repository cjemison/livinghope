...
urlpatterns = patterns('',
    ...
    url(r'^core-values/$', views.CoreValues.as_view(), name='core_values'),
    ...
    url(r'^missions-ministry-partners/$', views.missions_partners, name='missions_partners'),
    ...
    url(r'^donations/subscribe/$', views.DonationSubscriberFormView.as_view(),
        name="donation_subscriber"),
    url(r'^donations/unsubscribe/(?P<pk>\d{1,8})/$', views.donation_unsubscribe,
